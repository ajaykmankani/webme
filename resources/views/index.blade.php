...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-7B7LE2W26N"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-7B7LE2W26N');
</script>
<!-- Basic -->
<meta charset="utf-8">
...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    })(window,document,'script','dataLayer','GTM-TQSFFR4M');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TQSFFR4M"
			...
			<div class="row">
				<div class="col-md-12">
					<div class="contact_form">
						<div id="message"></div>
						<form  name="sentMessage" action="{{ route('query.store') }}" method="POST">
                            @csrf
							<div class="row">
								<div class="col-md-6">
